...
\rubric{1.} Verbe suprême
        qui sors du sein éternel du Père,
        et qui, né dans le temps,
        viens au secours de l’univers.\\\\
\rubric{2.} Illumine en ce moment nos cœurs;
        embrase-les de ton amour;
        pour que, détachés des biens périssables,
        ils soient remplis d’une joie céleste;\\\\
\rubric{3.} Afin, qu’au jour où le Juge,
        du haut de son tribunal,
        condamnera les coupables aux flammes;
        et, d’une voix amie, conviera les bons au ciel,\\\\
\rubric{4.} Nous ne soyons pas du nombre de ceux qui,
...
\rubric{8.} Exauce-nous, Père très miséricordieux,
